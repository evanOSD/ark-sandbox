...
import { saveRecording, saveKeyTermTranslation } from "../../../../loops/actions";
        ...
        <div className="lg:col-span-7 space-y-4">
          <Card className="overflow-hidden bg-zinc-950 border-zinc-800 text-white p-4">
            ...
            {(hasMultipleAudio || project.templates.mne_audio_url) && (
              <div className="flex flex-wrap items-center justify-between gap-2 mb-3 bg-zinc-900/40 p-2.5 rounded-lg border border-zinc-800">
                {hasMultipleAudio && (
